...
const DayPilotComponent = () => {
    const [view, setView] = useState("Week");
    const [startDate, setStartDate] = useState(DayPilot.Date.today());
    const [events, setEvents] = useState([]);

    const [calendarControlRef, setCalendarControlRef] = useState();

    console.log("calendarControlRef: ", calendarControlRef);
    ...
    const onTimeRangeSelected = async (args: { control: any; start: any; end: any }) => {
        ...
        <div className={"container"}>
            ...
            <div className={"content"}>
                <div className={"toolbar"}>
                    ...
                    <button onClick={() => setStartDate(DayPilot.Date.today())} className={"standalone"}>
                        Today
                    </button>
                </div>
                ...
                <DayPilotCalendar
                    ...
                    controlRef={setCalendarControlRef}
...
export default DayPilotComponent;
